...
using P6Answers_API_CrisM.Models;
using P6Answers_API_CrisM.ModelsDTOs;

namespace P6Answers_API_CrisM.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public ActionResult<IEnumerable<UsuarioDTO>> GetUserInfoByEmail(string pEmail)
        {
            ...
            // Lista para almacenar los datos consultados en formato DTO
            List<UsuarioDTO> list = new List<UsuarioDTO>();

            // Recorrer el resultado de la consulta y llenar el DTO
